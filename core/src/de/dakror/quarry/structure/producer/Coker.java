...
public class Coker extends ProducerStructure {
    public static final ProducerSchema classSchema = new ProducerSchema(0, StructureType.Coker, 4, 4,
            "coker",
            new Items(ItemType.MachineFrame, 25, ItemType.Dynamo, 30, ItemType.SteelTube, 60, ItemType.TinPlate, 100, ItemType.Glass, 50, ItemType.CarbonBlock, 20),
            new RecipeList() {
                @Override
                protected void init() {
            ...
            new Dock(2, 0, Direction.South, DockType.Power), new Dock(0, 2, Direction.West, DockType.FluidIn, new DockFilter(ItemType.RefinedOil)))
                    .sciences(ScienceType.AdvancedFuelProcessing)
